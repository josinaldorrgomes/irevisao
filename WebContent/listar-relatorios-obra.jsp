...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				<h4>Lista de relat&oacute;rios da obra</h4>
				<hr>
				<table class="table table-hover table-striped table-condensed">
					...
					<c:forEach var="relatorio" items="${requestScope.listarRelatoriosObra}">
						<tr>
				...
				<p>Total: ${fn:length(requestScope.listarRelatoriosObra)}</p>
			</div>
		</div>
	</div>
